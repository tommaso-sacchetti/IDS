...
def attention(query, key, value):
    ...
    #numerator = torch.matmul(query, key.T)
    #denominator = list(query.size())[2]
    #denominator = denominator.type(torch.FloatTensor)  # Cast to float32
    #output = numerator / (denominator**0.5)
